...
def test_ones_std(mode):
    """
    Feature: standard forward, backward features.
    Description: test function ones.
    ...
    if mode == "pynative":
        ...
        output = ones_forward_func(size, ms.float16)
    else:
        output = (jit(ones_forward_func, backend="ms_backend", jit_level="O0"))(size, ms.float16)
