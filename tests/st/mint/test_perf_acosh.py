...
# ============================================================================
""" acosh op performance test case """
...
def generate_random_input(shape, dtype):
    return np.random.uniform(1, 100, shape).astype(dtype)


def acosh_forward_perf(input):
