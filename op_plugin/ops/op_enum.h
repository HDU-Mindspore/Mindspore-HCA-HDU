...
#ifndef MS_PLUGIN_OP_ENUM_H_
#define MS_PLUGIN_OP_ENUM_H_
#include <cstdint>
#include <string>
#include <vector>
#include <memory>
...
namespace op_plugin {
int64_t StringToEnumImpl(const std::string &op_name, const std::string &arg_name,
