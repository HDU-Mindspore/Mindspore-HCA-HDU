...
namespace op_plugin {
namespace aten_op {
extern "C" int DivMods(int nparam, void **params, int *ndims, int64_t **shapes, const char **dtypes, void *stream,
                   void *extra) {
  ...
  auto at_scalar_input = input_utils.GetKernelInput<at::Scalar>(1);
  ...
  at::div_out(at_output, at_input1, at_scalar_input, pt_rounding_mode);
  return 0;
}
}  // namespace aten_op
}  // namespace op_plugin
